...
| Sonnet 连续两轮改错方向，而且每次都答得很笃定 | `/model opus` 切过去重做这一段 | 需求含糊的活直接开 `opusplan` |
...
| 连续两轮给出方向性错误的方案，而且每次都很笃定 | 不够懂 | `/model opus` |
